...
title: Unsafe GPIO Pins — ESP32-S3
description: >
  Complete reference of GPIO pins that must NOT be used for general-purpose I/O
  on ESP32-S3 with Octal PSRAM. Covers PSRAM/Flash bus pins, strapping pins,
  USB-JTAG, and system UART pins with explanations of crash mechanisms.
tags: [esp32-s3, gpio, psram, hardware, safety]
timestamp: 2026-07-08
---

# Unsafe GPIO Pins — ESP32-S3
...
| **27** | HD / D3 (Hold/Data 3) | PSRAM data bus | EN pin — `gpio_set_level` only ✅ (LL-027) |
...
| **27** | **TMC2209 EN** | **`gpio_set_level()` only** | **PSRAM bus** | **Low** | **✅ gpio_set_direction commented out** |
...
The three CRITICAL pins have been moved to safe GPIOs:
