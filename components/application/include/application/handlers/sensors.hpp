...
[[nodiscard]] std::expected<CommandResponse, domain::AppError> handleReadTemperature(
    int32_t tempCX100);
[[nodiscard]] std::expected<CommandResponse, domain::AppError> handleAdcCalGet(
    AdcCalReadCb read);
...
[[nodiscard]] std::expected<CommandResponse, domain::AppError> handleStallGuardGet(
    uint8_t threshold);
[[nodiscard]] std::expected<CommandResponse, domain::AppError> handleStallGuardSetThreshold(
